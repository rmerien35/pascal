...
final String nomfich_SOURCE = "prgs/jeu.pas";
final String nomfich_OBJET = "jeu.obj";
...
void prod_2()
{
   ...
   else if (code == Loader.code_pos("OR"))   empiler_op("OR ");
   else if (code == Loader.code_pos("AND"))  empiler_op("AND");
   else if (code == Loader.code_pos("NOT"))  empiler_op("NOT");
   else if (code == Loader.code_pos("NEG"))  empiler_op("NEG");
   else type_erreur(4);
}
...
void prod_9()
{
   ...
   else if (chaine.equals("INTEGER"))  tampon_typ = type_int;
...
void prod_11()
{
   ...
   else
   {
      ...
      while (! ((ptr_fonction == null) || (ptr_fonction.nom == tampon_chaine))) 
...
void produire_code()
{
   ...
   while (! (pointeur == null))
   {
      switch (pointeur.prod_lex) {
         ...
         case 29: prod_29(); break;   case 30: prod_30(); break;
      }
